/**
 * @file
 * @brief MPU6050 driver made 
 * @author José Tomas Grangetto
 * 
 * See also
...
/**
 * @brief UPGRADED: Create and init sensor object and return a sensor handle
 *
 * @param dev_handle I2C master device handle
 *
 * @return
 *     - NULL Fail
 *     - Others Success
